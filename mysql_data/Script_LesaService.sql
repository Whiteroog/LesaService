...
START TRANSACTION;
USE `DB_LesaService`;
INSERT INTO `DB_LesaService`.`orders` (`id`, `login`, `product_id`, `payment_status`, `order_date`, `total_price`) VALUES (1, 'User1', 1, 'Ожидайте', DEFAULT, 100);
INSERT INTO `DB_LesaService`.`orders` (`id`, `login`, `product_id`, `payment_status`, `order_date`, `total_price`) VALUES (2, 'User2', 2, 'Ожидайте', DEFAULT, 120);
INSERT INTO `DB_LesaService`.`orders` (`id`, `login`, `product_id`, `payment_status`, `order_date`, `total_price`) VALUES (3, 'User1', 3, 'Ожидайте', DEFAULT, 125);
INSERT INTO `DB_LesaService`.`orders` (`id`, `login`, `product_id`, `payment_status`, `order_date`, `total_price`) VALUES (4, 'User2', 1, 'Ожидайте', DEFAULT, 100);
...
START TRANSACTION;
USE `DB_LesaService`;
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (1, 7, 4);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (1, 8, 1);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (1, 9, 1);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (1, 10, 1);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (1, 11, 1);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (1, 12, 2);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (1, 13, 3);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (2, 14, 4);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (2, 16, 1);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (2, 8, 1);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (2, 9, 1);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (2, 11, 1);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (2, 12, 2);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (2, 13, 3);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (3, 14, 4);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (3, 8, 1);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (3, 9, 1);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (3, 16, 1);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (3, 11, 1);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (3, 12, 2);
INSERT INTO `DB_LesaService`.`parts_in_products` (`product_id`, `part_id`, `number`) VALUES (3, 15, 3);
...
START TRANSACTION;
USE `DB_LesaService`;
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (1, 7, 4);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (1, 8, 1);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (1, 9, 1);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (1, 10, 1);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (1, 11, 1);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (1, 12, 2);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (1, 13, 3);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (2, 14, 4);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (2, 16, 1);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (2, 8, 1);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (2, 9, 1);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (2, 11, 1);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (2, 12, 2);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (2, 13, 3);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (3, 14, 4);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (3, 8, 1);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (3, 9, 1);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (3, 16, 1);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (3, 11, 1);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (3, 12, 2);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (3, 15, 3);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (4, 7, 4);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (4, 8, 1);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (4, 9, 1);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (4, 10, 1);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (4, 11, 1);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (4, 12, 2);
INSERT INTO `DB_LesaService`.`parts_in_orders` (`order_id`, `part_id`, `number`) VALUES (4, 13, 3);
